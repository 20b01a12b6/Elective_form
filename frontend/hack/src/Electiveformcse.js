...
const [subject2,setsubject2]=useState("")
  const onSubmit=(data)=>{
    console.log(data)
axios.post("http://localhost:3001/eform1",
{
...
<br />
      ...
      <br/>
      <div>
        <button onClick={Report1}>CSE BATCH REPORT</button>
      </div>
    </div>
...
export default Electiveformcse ;